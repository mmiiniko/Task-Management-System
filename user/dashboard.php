...
$stmt = $pdo->prepare("SELECT COUNT(*) as archived_tasks FROM finished_tasks WHERE user_id = ?");
$stmt->execute([$user_id]);
$archived_tasks_count = $stmt->fetchColumn();

// Calculate total finished tasks
$total_finished_tasks = $dashboard_data['done_tasks'] + $archived_tasks_count;
                        ...
                        <div class="bg-white rounded-lg shadow-md p-6 border-t-4 border-green-500">
                            <div class="flex items-center">
                                ...
                                <div class="mx-4">
                                    ...
                                    <p class="text-3xl font-bold text-gray-800"><?php echo $dashboard_data['finished_tasks']; ?></p>
                                </div>
                            </div>
